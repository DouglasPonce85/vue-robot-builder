...
export default {
  ...
  methods: {
    addToCart() {
      ...
      const headCost = robot.head.cost ? robot.head.cost : 0;
      const leftArmCost = robot.leftArm.cost ? robot.leftArm.cost : 0;
      const rightArmCost = robot.rightArm.cost ? robot.rightArm.cost : 0;
      const baseCost = robot.base.cost ? robot.base.cost : 0;
